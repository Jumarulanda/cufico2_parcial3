...
namespace df
{
    ...
    double R1 = 2.;   //Radius of the inner sphere
    double R2 = 4.;   //Radius of the outer sphere
    double V1 = 110.; // Voltage at the inner sphere
    double V2 = 0.;   // Voltage at the outer sphere
    ...
    vector<double> boundary =  {V1,V2,R1,R2}; 
