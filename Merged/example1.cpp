...
namespace df
{
    ...
    double S = 1.;  // Stress at endpoints
    double E = 1.;  // Modulus of elasticity
    double l = 1.;  // Length of the load
    double q = 1.;  // Intensity of the uniform load
...
{       
    ...
    ofstream file ("example1.txt"); // File for storing solutions
